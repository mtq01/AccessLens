...
const PATHS = {
  ...
  build:              "M13.7 7.34l1.41 1.41-9.19 9.2-1.41-1.41 9.19-9.2zm-1.83-4.76L8.34 6.1l1.41 1.41 1.06-1.06 1.41 1.41-2.12 2.12 1.41 1.41L14.93 7 11.87 2.58zM3 18.17l2.83 2.83 8.48-8.48-2.83-2.83L3 18.17zm14.95-7.75l-1.58-1.58-1.41 1.41 1.58 1.58-5.65 5.66 1.41 1.41 7.07-7.07-.01.01-.01-.01.01-.01z",
  warning_amber:      "M12 5.99L19.53 19H4.47L12 5.99M12 2L1 21h22L12 2zm1 14h-2v2h2v-2zm0-6h-2v4h2v-4z",
  ...
  block:              "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-4.42 3.58-8 8-8 1.85 0 3.55.63 4.9 1.68L5.68 16.9A7.902 7.902 0 0 1 4 12zm8 8c-1.85 0-3.55-.63-4.9-1.68L18.32 7.1A7.902 7.902 0 0 1 20 12c0 4.42-3.58 8-8 8z",
  check_circle_outline:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm4.59-12.42L10 14.17l-2.59-2.58L6 13l4 4 8-8-1.41-1.42z",
  ...
  movie_filter:       "M18 3v2h-2V3H8v2H6V3H4v18h2v-2h2v2h8v-2h2v2h2V3h-2zM8 17H6v-2h2v2zm0-4H6v-2h2v2zm0-4H6V7h2v2zm10 8h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2V7h2v2zm-4.5 2L11 9v3H9v2h2v3l2.5-3H16v-2h-2.5z",
  ...
  feedback:           "M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-7 12h-2v-2h2v2zm0-4h-2V6h2v6z",
  ...
  gps_fixed:          "M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm8.94 3A8.994 8.994 0 0 0 13 3.06V1h-2v2.06A8.994 8.994 0 0 0 3.06 11H1v2h2.06A8.994 8.994 0 0 0 11 20.94V23h2v-2.06A8.994 8.994 0 0 0 20.94 13H23v-2h-2.06zM12 19c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z",
